...
exports.AutMethod = exports.$Enums.AutMethod = {
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/vladislavsizyh/Desktop/task-manager/backend/prisma/__generated__",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/vladislavsizyh/Desktop/task-manager/backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:qwerty@localhost:5432/todoDB"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./__generated__\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"POSTGRES_URL\")\n}\n\nmodel User {\n  id String @id @default(uuid())\n\n  email    String @unique\n  password String\n\n  username String  @unique\n  picture  String?\n\n  role UserRole @default(OWNER)\n\n  method AutMethod\n\n  accounts Account[]\n\n  isVerified         Boolean @default(false) @map(\"is_verified\")\n  isTwoFactorEnabled Boolean @default(false) @map(\"is_two_factor_enabled\")\n\n  createdAt DateTime @default(now()) @map(\"created_at\")\n  updatedAt DateTime @updatedAt @map(\"updated_at\")\n\n  @@map(\"users\")\n}\n\nmodel Account {\n  id String @id @default(uuid())\n\n  type     String\n  provider String\n\n  refreshToken String? @map(\"refresh_token\")\n  accessToken  String? @map(\"access_token\")\n  expiresAt    Int     @map(\"expires_at\")\n\n  createdAt DateTime @default(now()) @map(\"created_at\")\n  updatedAt DateTime @updatedAt @map(\"updated_at\")\n\n  user   User?   @relation(fields: [userId], references: [id])\n  userId String? @map(\"user_id\")\n\n  @@map(\"accounts\")\n}\n\nmodel Token {\n  id String @id @default(uuid())\n\n  email     String\n  token     String    @unique\n  type      TokenType\n  expiresIn DateTime  @map(\"expires_in\")\n\n  createdAt DateTime @default(now()) @map(\"created_at\")\n\n  @@map(\"tokens\")\n}\n\nenum UserRole {\n  OWNER\n  GUEST\n  WORKER\n}\n\nenum AutMethod {\n  CREDENIALS\n  GOOGLE\n  YANDEX\n  EMAIL\n}\n\nenum TokenType {\n  VERIFICATION\n  TWO_FACTOR\n  PASSWORD_RESET\n}\n",
  "inlineSchemaHash": "7629eaf1c79db04878eb900ad34580242dc97fbd8ac6ad0ade60907a91f0342b",
  "copyEngine": true
}
